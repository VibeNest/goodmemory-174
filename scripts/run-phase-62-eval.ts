...
export function buildLongMemEvalPrompt(input: {
  ...
  return [
    ...
    "For total, sum, or page-count questions, add the visible matching numeric values and return the resulting total; do not answer No answer when all operands are visible.",
