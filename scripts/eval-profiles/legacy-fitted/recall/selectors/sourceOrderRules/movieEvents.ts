...
const CONTRIBUTION_FACETS = [
  ...
  {
    facet: "movieChoice",
    pattern: /\bForrest\s+Gump\b[\s\S]{0,180}\b(?:heartwarming|classic|friends?\s+from\s+college)\b/iu,
  },
  {
    facet: "animatedSnack",
  ...
  {
    facet: "playlist",
    pattern: /\bplaylist\s+of\s+30\s+songs\b[\s\S]{0,180}\bkaraoke\s+night\b/iu,
  },
  {
    facet: "boardGames",
    pattern: /\bbrought\s+board\s+games\b[\s\S]{0,180}\bsent\s+a\s+gift\s+card\b/iu,
  },
] as const satisfies ReadonlyArray<{
