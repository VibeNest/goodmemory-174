...
项目内 `npm install goodmemory@0.3.5` 不会把 `goodmemory` 放进 shell 的 `PATH`。
...
`npm install -g goodmemory@0.3.5` 安装的全局 CLI。本地 dependency install
