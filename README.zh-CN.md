...
| LoCoMo（完整 10 会话） | 回答准确率——确定性 token-F1、无判官 | **0.6198** 整体（1986 题）；**0.6117** 非对抗（942/1540）；evidence recall 0.769 | 无记忆基线整体 0.2276；非对抗 0.0045（7/1540） | [locomo.json](./benchmark-claims/locomo.json) |
