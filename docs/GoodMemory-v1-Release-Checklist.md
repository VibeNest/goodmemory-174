...
- `0.2.5` packages `goodmemory`, `goodmemory/ai-sdk`, `goodmemory/host`, and `goodmemory/http` through compiled `dist/` outputs plus declarations
...
- `package.json` is not private and uses version `0.2.5`
