...
- Latest accepted BEAM retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-zoom-call-schedule-update-group-current-20260615T172117Z`, evidence-chat recall 0.9540800357701766, missed 25/355, wrong-recall/noise 172/400, zero-recall 0, and hit/missing/noise ids 1012/82/825 -> 1013/81/824 (8:knowledge_update:1 recovered from recall 0.667 to 1 — second answer_ai_question recovery via the multiFacetGroups matcher; the missing turn 96 is a markerless schedule-confirmation dump, recovered alongside the original/reschedule turns, returns [92,94,96]; cleanest single delta, zero ripples; the schedule facet keys on "schedule for April 22"+"Team meeting" to avoid the disallowed names in that turn). Remaining partial-recall families: knowledge_update (1 — 11:ku:2, answer_ai_question, via multiFacetGroups), instruction_following (6 — via the instructionRules companionPattern recipe, NOT multiFacetGroups: a multiFacetGroups attempt on 1:if:1 was reverted for colliding with the existing instruction-continuation mechanism), multi_session_reasoning (11, "how many" aggregates have an upstream candidate-pool recall gap).
