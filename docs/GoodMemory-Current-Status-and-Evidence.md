...
- Latest accepted BEAM retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-career-relocation-event-order-current-20260613T045654Z`, evidence-chat recall 0.8786899172814665, missed 76/355, wrong-recall/noise 219/400, zero-recall 0, and hit/missing/noise ids 918/176/1187 -> 922/172/1160 (first post-zero-recall noise-reduction pass: 6:event_ordering:2 recovered from recall 0.2 to 1 and shed 27 noisy chats; one recall-neutral noise swap on 6:information_extraction:1).
