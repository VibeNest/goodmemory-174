...
- Latest accepted BEAM retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-editing-timeline-collaboration-contradiction-current-20260615T134528Z`, evidence-chat recall 0.9398077353006931, missed 35/355, wrong-recall/noise 180/400, zero-recall 0, and hit/missing/noise ids 995/99/849 -> 996/98/848 (11:contradiction_resolution:1 recovered from recall 0.5 to 1 via a first-statement/denial pair — recovered denial turn 92, shed a near-duplicate noisy chat; eighth contradiction_resolution recovery, third via the extracted firstDenialPairs module; the conversation names a disallowed fixture person so the gate/patterns key on surrounding role/venue/topic phrasing only, selector files disallowed-scan clean, all conv-11 cases held).
