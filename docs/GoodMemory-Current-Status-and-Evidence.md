...
- Latest accepted BEAM retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-trilogy-reading-interval-current-20260615T142449Z`, evidence-chat recall 0.9426246367091438, missed 33/355, wrong-recall/noise 178/400, zero-recall 0, and hit/missing/noise ids 997/97/846 -> 998/96/841 (13:temporal_reasoning:1 recovered from recall 0.5 to 1 via a START/END interval anchor pair — recovered end-anchor turn 154, shed five noisy chats; eleventh temporal_reasoning recovery). Routing correction: "how many days did it take ... after" interval questions route via the per-case gate alone (the source_ordered_temporal_interval route serves on candidates>0 and aggregate_evidence stands down) — NO broad-gate widening of isTemporalIntervalQuery is needed, contrary to a prior note. Only 18:tr:1 now remains below recall 1 in the temporal_reasoning family, recoverable via the same per-case-gate recipe.
