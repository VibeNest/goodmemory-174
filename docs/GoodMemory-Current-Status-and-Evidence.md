...
- Latest accepted BEAM retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-contradiction-firstdenial-extract-current-20260615T124515Z`, evidence-chat recall 0.935582383188017, missed 38/355, wrong-recall/noise 183/400, zero-recall 0 — a behavior-preserving extraction (the first/denial contradiction machinery moved from contradiction.ts 897->699 lines into contradictionRules/firstDenialPairs.ts; analyzer shows zero case deltas vs the personal-statement-scholarship baseline). The prior recall change was 9:temporal_reasoning:1 (tenth temporal_reasoning recovery, hit/missing/noise ids 993/101/854). The extraction frees room under the 900-line cap to resume contradiction_resolution pair recoveries.
