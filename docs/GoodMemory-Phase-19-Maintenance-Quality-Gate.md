...
- Summary artifact:
  - `reports/quality-gates/phase-19-maintenance/run-20260419061145/phase-19-maintenance-quality-gate.json`
...
- The canonical accepted report lives under `reports/quality-gates/phase-19-maintenance/run-20260419061145/`.
