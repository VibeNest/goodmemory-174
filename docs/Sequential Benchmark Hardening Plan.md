...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-patent-process-stages-event-order-current-20260614T230256Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-sneaker-safety-event-order-current-20260613T054324Z`, it raises evidence-chat recall to 0.8880795886429688, lowers missed-recall cases to 71/355 and wrong-recall/noise to 214/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 936/158/1054 to 938/156/1029 — a 25-id net noise drop. Target `20:event_ordering:2` ("order in which I brought up different aspects of my patent process ... five items") goes from recall 0.6 to full recall: it recovers the two missing designated turns 122/190 (32/70/188 were already hits) and sheds all 25 noisy chats with zero new noise. The repair adds a `patentProcessStagesEventOrder` coverage selector (five facets — prior-art plan turn 32, prior-art complete turn 70, provisional filed turn 122, non-provisional draft turn 188, review/milestones turn 190) chained in `sourceOrderTemporal.ts` with a `patentProcessStagesEventOrderPlanActive` flag OR'd into `sourceOrderedNamedEntityEventPlanActive`. This is the cleanest pass to date: exactly one case delta, no same-conversation ripples, no hit-loss, no newly-missing evidence. It is the sixth event-order coverage selector; the family of "list the order I brought up aspects of X" questions remains the steady noise-reduction workstream.
