...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-permutations-quiz-score-interval-current-20260615T115407Z`. Eighth temporal_reasoning interval recovery. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-casting-pilot-episode-interval-current-20260615T113326Z`, it raises evidence-chat recall to 0.9327654817795663, lowers missed-recall cases to 40/355 and wrong-recall/noise to 185/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 990/104/868 to 991/103/863. Target `5:temporal_reasoning:2` ("How many days passed between when I focused on permutations and combinations starting on April 5, 2024, and when I improved my quiz score after practicing 15 problems?", answer 10 days) goes from recall 0.5 to full recall: it recovers the missing start-anchor turn 138 ("permutations, combinations, and probability puzzles ... current focus on April 5, 2024") to pair with the already-hit end-anchor turn 186 ("quiz score from 75% to 92% after practicing 15 problems"), and sheds its five noisy chats (48/196/68/44/60). The repair adds a `permutationsQuizScoreDays` interval case to `sourceOrderTemporalInterval.ts` (gate `temporalInterval.permutationsQuizScoreDays` = "permutations and combinations" && "quiz score", 1/400; START/END patterns plus the four ternary-chain edits). Cleanest possible pass: exactly one case delta, zero ripples — conv-5 carries 5:tr:1 at recall 1, and it held even though the shed-noise turn 48 itself names "permutations and combinations". Eight temporal_reasoning cases now recovered. The remaining partial-recall families are temporal_reasoning (4), multi_session_reasoning (11), contradiction_resolution (9, but contradiction.ts is 897/900 so the next contradiction case needs per-case module extraction first), instruction_following (6, all blocked by answer_ai_question companion turns), and knowledge_update (3, all answer_ai_question).
