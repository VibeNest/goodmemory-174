...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-prior-art-provisional-patent-days-current-20260613T030934Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-emergency-fund-days-current-20260613T025723Z`, it raises evidence-chat recall to 0.8595349877040017, lowers missed-recall cases to 83/355, wrong-recall/noise to 226/400, and zero-recall to 6, and moves global hit/missing/noise ids from 906/188/1222 to 908/186/1217. Target `20:temporal_reasoning:1` goes from zero recall to full recall, returning the two designated turns 32/70 while removing the noisy chats 302/300/77/79/164, with zero new noise and exactly one case delta. The repair adds a `temporalInterval.priorArtProvisionalPatentDays` narrow gate to `sourceOrderTemporalInterval.ts` keyed on the "how many days" / "prior art search" / "provisional patent" question, with a start pattern pinned to the April 10 prior-art-search-plan turn (32, "plan to complete by April 10, 2024" + "USPTO database and Google Patents") and an end pattern requiring both the completed-April-10 search and the May 15 provisional-filing anchors (70) so it excludes a later May-15 provisional turn (124).
