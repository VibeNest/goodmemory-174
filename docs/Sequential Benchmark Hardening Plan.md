...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-probate-timeline-update-current-20260613T032048Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-prior-art-provisional-patent-days-current-20260613T030934Z`, it raises evidence-chat recall to 0.8623518891124524, lowers missed-recall cases to 82/355, wrong-recall/noise to 225/400, and zero-recall to 5, and moves global hit/missing/noise ids from 908/186/1217 to 910/184/1216. Target `19:knowledge_update:1` goes from zero recall to full recall, returning the two designated turns 112/122 while removing the noisy chat 110, with zero new noise and exactly one case delta. The repair adds a `probateTimeline` module to the `updateSeriesRules` registry: gate `updateSeries.probateTimeline` keys on the "probate process" / "Montserrat" question, the original pattern pins the 6-9 month turn ("probate timeline" + "typically takes 6-9 months in Montserrat", turn 112) and the updated pattern pins the 5-7 month turn ("shortened to 5-7 months", turn 122); the patterns avoid the turn's attorney name so the selector file stays free of the disallowed fixture name, and the selector's user-role filter drops the assistant echo of the 5-7 month figure.
