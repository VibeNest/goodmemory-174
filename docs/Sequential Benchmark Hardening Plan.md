...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-patent-timelines-instruction-current-20260613T042720Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-legal-terms-explanation-instruction-current-20260613T041812Z`, it raises evidence-chat recall to 0.8736194947462552, lowers missed-recall cases to 78/355, wrong-recall/noise to 221/400, and zero-recall to 1, and moves global hit/missing/noise ids from 915/179/1198 to 916/178/1192. Target `20:instruction_following:1` goes from zero recall to full recall, returning the single designated standing-instruction turn 66 while removing all six noisy chats 174/228/362/46/186/202, with zero new noise and exactly one case delta. Now that the instructionRules registry and the generic instruction routing are in place, this single-turn family was a pure additive repair: a new `instruction.patentTimelines` module (gate on the "get a patent approved" question + the "always provide detailed timelines when I ask about patent application processes" turn pattern) plus one registry entry and one enrichment entry, with no selection.ts or selectionRunContext.ts changes.
