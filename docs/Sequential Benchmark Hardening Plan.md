...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-emergency-fund-days-current-20260613T025723Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-holiday-gift-budget-update-current-20260613T024529Z`, it raises evidence-chat recall to 0.856718086295551, lowers missed-recall cases to 84/355, wrong-recall/noise to 227/400, and zero-recall to 7, and moves global hit/missing/noise ids from 904/190/1223 to 906/188/1222. Target `16:temporal_reasoning:2` goes from zero recall to full recall, returning the two designated turns 76/146 while removing the noisy chat 42, with zero new noise and exactly one case delta. The repair adds a `temporalInterval.emergencyFundDays` narrow gate to `sourceOrderTemporalInterval.ts` keyed on the "how long did it take" / "emergency fund" question, with a start pattern pinned to the June 5 $1,200 milestone turn (76) and an end pattern pinned to the August 30 $2,000 goal-reached turn (146).
