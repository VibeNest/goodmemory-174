...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-resume-ats-sequencing-current-20260612T110000Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-family-movie-marathon-titles-current-20260612T100000Z`, it raises evidence-chat recall to 0.7617259110216855, missed-recall cases to 118/355, wrong-recall/noise to 261/400, zero-recall cases to 39, and global hit/missing/noise ids from 808/286/1400 to 814/280/1394. Target `6:multi_session_reasoning:2` goes from zero recall to full recall, returning the six resume-ATS sequencing turns 22/23/92/93/136/137 (LinkedIn Learning course progress, the five-interview leverage exchange, and the digital-media-leadership courses achievement) while removing noisy chats 94/46/36/37/124/125; the per-query instruction stand-down is now a single run-context flag shared by complete-evidence query families.
