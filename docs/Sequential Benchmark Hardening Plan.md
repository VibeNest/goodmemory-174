...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-movie-list-game-night-days-current-20260612T191900Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-outlander-reading-days-current-20260612T185300Z`, it raises evidence-chat recall to 0.8426335792532975, lowers missed-recall cases to 89/355, wrong-recall/noise to 232/400, and zero-recall to 12, and moves global hit/missing/noise ids from 896/198/1246 to 897/197/1243. Target `14:temporal_reasoning:2` goes from zero recall to full recall, returning the single designated turn 208 (the benchmark lists the same turn as both interval endpoints: the May 5 movie-list deadline and the May 11 game-night suggestion live in one user turn) while removing all three noisy chats 122/192/194, with zero new noise and exactly one case delta. Second use of the same-turn interval recipe introduced in the previous pass: both patterns pin the combined two-anchor turn and the identical-endpoint dedupe returns it once.
