...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-film-office-movies-interval-current-20260615T063006Z`. Second temporal_reasoning interval recovery. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-first-draft-essay-grade-interval-current-20260615T061734Z`, it raises evidence-chat recall to 0.9243147775542142, lowers missed-recall cases to 46/355 and wrong-recall/noise to 191/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 984/110/888 to 985/109/887. Target `14:temporal_reasoning:1` ("How many days passed between my meeting at the Montserrat Film Office and when I finished watching all the movies despite the nap delay?", answer 11 days) goes from recall 0.5 to full recall: it recovers the missing end-anchor turn 154 ("2-hour nap delay on April 6") to pair with the already-hit start-anchor turn 46 ("meeting at Montserrat Film Office on March 20"), and sheds its one noisy chat (4). The repair adds a `filmOfficeMoviesDays` interval case to `sourceOrderTemporalInterval.ts` (gate `temporalInterval.filmOfficeMoviesDays` = "Montserrat Film Office" && "nap delay", 1/400; START/END patterns plus the four ternary-chain edits the recipe uses). Cleanest possible pass: exactly one case delta, zero ripples — conv-14 carries 14:tr:2 at recall 1, which held. Two temporal_reasoning cases now recovered. The remaining partial-recall families are temporal_reasoning (10), multi_session_reasoning (11), contradiction_resolution (9, but contradiction.ts is 897/900 so the next contradiction case needs per-case module extraction first), instruction_following (6, all blocked by answer_ai_question companion turns), and knowledge_update (3, all answer_ai_question).
