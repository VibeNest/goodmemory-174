...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-family-movie-invite-current-20260612T165000Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-winter-reading-challenge-current-20260612T163500Z`, it raises evidence-chat recall to 0.8200983679856918, lowers missed-recall cases to 97/355, wrong-recall/noise to 240/400, and zero-recall to 20, and moves global hit/missing/noise ids from 886/208/1277 to 888/206/1273. Target `14:contradiction_resolution:2` goes from zero recall to full recall, returning the contradiction pair 108/148 (the never-invited denial and the nap-time scheduling statement) while removing all four noisy chats 88/90/130/264. Accepted tradeoff: `14:knowledge_update:2` (still zero recall, itself a future target) swaps noise 216 for 108 through same-conversation reinforcement, noise count unchanged.
