...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-screenplay-draft-days-current-20260612T154500Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-reunion-promotion-days-current-20260612T153000Z`, it raises evidence-chat recall to 0.8088307623518892, lowers missed-recall cases to 101/355, wrong-recall/noise to 244/400, and zero-recall to 24, and moves global hit/missing/noise ids from 878/216/1295 to 880/214/1292. Target `10:temporal_reasoning:1` goes from zero recall to full recall, returning the interval pair 20/54 (the 5,000-word screenplay draft goal due April 15, 2024 and the 3,600 words logged by March 3) while removing all three noisy chats 296/302/304. Exactly one case delta; no tradeoffs.
