...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-outlander-reading-days-current-20260612T185300Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-onboarding-modules-completion-current-20260612T184300Z`, it raises evidence-chat recall to 0.8398166778448468, lowers missed-recall cases to 90/355, wrong-recall/noise to 233/400, and zero-recall to 13, and moves global hit/missing/noise ids from 895/199/1251 to 896/198/1246. Target `13:temporal_reasoning:2` goes from zero recall to full recall, returning the single designated turn 296 (the benchmark lists the same turn as both interval endpoints: the March 8 job start and the June 30 Outlander deadline live in one user turn) while removing all five noisy chats 62/306/136/95/141, with zero new noise and exactly one case delta. The repair pins both interval patterns to the combined two-anchor turn and adds an identical-endpoint dedupe to the interval selector so same-turn intervals return one entry.
