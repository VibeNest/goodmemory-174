...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-resume-tailoring-apply-days-current-20260612T151500Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-executive-producer-interviews-current-20260612T150000Z`, it raises evidence-chat recall to 0.8031969595349878, lowers missed-recall cases to 103/355, wrong-recall/noise to 246/400, and zero-recall to 26, and moves global hit/missing/noise ids from 874/220/1307 to 876/218/1301. Target `6:temporal_reasoning:1` goes from zero recall to full recall, returning the interval pair 14/16 (the April 10, 2024 resume-tailoring deadline for film, television, and digital media and the June 1, 2024 executive-producer apply-confidence target) while removing all six noisy chats 252/46/36/37/124/125. Exactly one case delta; no tradeoffs.
