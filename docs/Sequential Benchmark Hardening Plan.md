...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-patent-funding-event-order-current-20260613T052049Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-ai-hiring-event-order-current-20260613T050930Z`, it raises evidence-chat recall to 0.8829152693941426, lowers missed-recall cases to 74/355 and wrong-recall/noise to 217/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 927/167/1133 to 931/163/1105 — a 28-id net noise drop with exactly one case delta and no ripples. Target `20:event_ordering:1` ("order in which I brought up aspects of my patent filing plans and related funding discussions ... six items") goes from recall 0.33 to full recall: it recovers the four missing designated turns 30/200/204/206 (164/202 were already hits) and sheds all 28 noisy chats. The repair adds a `patentFundingEventOrder` coverage selector (six facets — provisional filing turn 30, non-provisional filing turn 164, PCT application turn 200, PCT funding turn 202, funding option turn 204, crowdfunding turn 206) chained in `sourceOrderTemporal.ts` with a `patentFundingEventOrderPlanActive` flag OR'd into `sourceOrderedNamedEntityEventPlanActive`; the near-duplicate PCT turn 370 is excluded by the "I've decided to file a PCT application" phrasing and the non-provisional turn 164 is distinguished from the pass-43 confirmation turn 182 by the "deadline to meet for my non-provisional patent filing ... set for November 10, 2024" phrasing.
