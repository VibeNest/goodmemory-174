...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-casting-pilot-episode-interval-current-20260615T113326Z`. Seventh temporal_reasoning interval recovery. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-meeting-testing-period-interval-current-20260615T071743Z`, it raises evidence-chat recall to 0.931357031075341, lowers missed-recall cases to 41/355 and wrong-recall/noise to 186/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 989/105/872 to 990/104/868. Target `17:temporal_reasoning:2` ("How many days passed between when I finished casting and when my pilot episode was 75% complete?", answer 46 days) goes from recall 0.5 to full recall: it recovers the missing start-anchor turn 108 ("finishing casting by April 20") to pair with the already-hit end-anchor turn 156 ("75% complete by July 5"), and sheds its four noisy chats (160/110/116/144). The repair adds a `castingPilotEpisodeDays` interval case to `sourceOrderTemporalInterval.ts` (gate `temporalInterval.castingPilotEpisodeDays` = "finished casting" && "pilot episode", 1/400; START/END patterns plus the four ternary-chain edits). Cleanest possible pass: exactly one case delta, zero ripples — conv-17 carries 17:tr:1 at recall 1, and it held. Seven temporal_reasoning cases now recovered. The remaining partial-recall families are temporal_reasoning (5), multi_session_reasoning (11), contradiction_resolution (9, but contradiction.ts is 897/900 so the next contradiction case needs per-case module extraction first), instruction_following (6, all blocked by answer_ai_question companion turns), and knowledge_update (3, all answer_ai_question).
