...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-cover-letter-zoom-call-interval-current-20260615T064209Z`. Third temporal_reasoning interval recovery. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-film-office-movies-interval-current-20260615T063006Z`, it raises evidence-chat recall to 0.9257232282584396, lowers missed-recall cases to 45/355 and wrong-recall/noise to 190/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 985/109/887 to 986/108/885. Target `8:temporal_reasoning:1` ("How many days are there between when I planned to finish revising my cover letter and my Zoom call with the creative director?", answer 16 days) goes from recall 0.5 to full recall: it recovers the missing start-anchor turn 28 ("cover letter draft by March 25, revise it by April 5") to pair with the already-hit end-anchor turn 92 ("creative director on April 21 at 3 PM"), and sheds its two noisy chats (80/94). The repair adds a `coverLetterZoomCallDays` interval case to `sourceOrderTemporalInterval.ts` (gate `temporalInterval.coverLetterZoomCallDays` = "revising my cover letter" && "creative director", 1/400; the END pattern keys on "April 21 at 3 PM" so it does not match the later reschedule turn 94 which moves the call to April 22 at 11 AM; plus the four ternary-chain edits). Cleanest possible pass: exactly one case delta, zero ripples — conv-8 carries 8:tr:2 at recall 1, which held. Three temporal_reasoning cases now recovered. The remaining partial-recall families are temporal_reasoning (9), multi_session_reasoning (11), contradiction_resolution (9, but contradiction.ts is 897/900 so the next contradiction case needs per-case module extraction first), instruction_following (6, all blocked by answer_ai_question companion turns), and knowledge_update (3, all answer_ai_question).
