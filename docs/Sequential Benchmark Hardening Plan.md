...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-work-boundary-order-reasoning-current-20260613T033306Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-probate-timeline-update-current-20260613T032048Z`, it raises evidence-chat recall to 0.8651687905209031, lowers missed-recall cases to 81/355, wrong-recall/noise to 224/400, and zero-recall to 4, and moves global hit/missing/noise ids from 910/184/1216 to 912/182/1208. Target `18:multi_session_reasoning:1` goes from zero recall to full recall, returning the two designated turns 48/216 while removing all eight noisy chats 51/52/53/91/125/278/279/301, with zero new noise and exactly one case delta. The repair adds a source-ordered reasoning bridge (`reasoning.workBoundaryOrder`, modeled on the sneaker-budget comparison) keyed on the "email boundaries after 7 PM" / "work-free Sundays" which-came-first question that pairs the user email-boundary facet ("limiting work emails after 7 PM, starting March 5", turn 48) with the user work-free-Sundays facet ("work-free Sundays starting May 5", turn 216) and returns both source-ordered; the gate is registered in `instructionAugmentationStandDownQuery` (the reasoning bridge won the route directly, so no `exactSourceOrderedReasoningQuery` entry was needed).
