...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-transaction-deployment-weeks-current-20260612T141500Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-book-series-genres-current-20260612T140000Z`, it raises evidence-chat recall to 0.7919293539011849, lowers missed-recall cases to 107/355, wrong-recall/noise to 250/400, and zero-recall to 30, and moves global hit/missing/noise ids from 866/228/1324 to 868/226/1319. Target `1:temporal_reasoning:1` goes from zero recall to full recall, returning the interval pair 0/2 (the March 15, 2024 time-anchor turn and the milestone breakdown placing transaction management at January 15) while removing all five noisy chats 184/3/9/35/28. Exactly one case delta; no tradeoffs.
