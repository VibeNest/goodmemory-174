...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-work-email-self-care-interval-current-20260615T144025Z`. Twelfth temporal_reasoning interval recovery — and it FULLY RECOVERS the temporal_reasoning family (all 40 tr cases now at recall 1). Compared with the trilogy baseline (20260615T142449Z), it raises evidence-chat recall to 0.9440330874133691, lowers missed-recall cases to 32/355 and wrong-recall/noise to 177/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 998/96/841 to 999/95/837. Target `18:temporal_reasoning:1` ("How many days after I started limiting work emails after 7 PM did I begin blocking time for self-care on Tuesday and Thursday mornings?", answer 2 days) goes from recall 0.5 to full recall: it recovers the missing end-anchor turn 60 ("blocking 2 hours every Tuesday and Thursday morning for self-care starting March 7") to pair with the already-hit start-anchor turn 48 ("limiting work emails after 7 PM, starting March 5"), and sheds its four noisy chats (96/328/268/164). Like the trilogy case (pass 87) this uses the "days after I started" phrasing that the broad isTemporalIntervalQuery heuristic does not match, recovered cleanly with a per-case gate alone (`temporalInterval.workEmailSelfCareDays` = "limiting work emails" && "self-care", 1/400) + START/END patterns + four ternary-chain edits — no broad-gate change. Cleanest possible pass: exactly one case delta, zero ripples; the full tr scan now shows ZERO cases below recall 1. With the temporal_reasoning family complete, the remaining partial-recall families are contradiction_resolution (5 — 3-5-turn multi-evidence cases outside the simple pair recipe), multi_session_reasoning (11, "how many" aggregates have an upstream candidate-pool recall gap), instruction_following (6, answer_ai_question-blocked), and knowledge_update (3, answer_ai_question-blocked). Next loop reassesses among the multi-evidence contradiction cases and the msr candidate-pool gap. The prior accepted recall change was the eleventh temporal_reasoning recovery (13:temporal_reasoning:1, trilogy download-to-finish), which established that "how many days did it take ... after" interval questions route via a per-case gate alone (no broad-gate widening); the twelve temporal_reasoning recoveries (passes 72-81, 87, 88) have now brought every tr case to recall 1.
