...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-autocomplete-null-check-denial-v1-current-20260610T203000Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-event-order-user-anchored-v1-current-20260610T170000Z`, it raises evidence-chat recall to 0.7443635550677804, missed-recall cases to 126/355, wrong-recall/noise to 270/400, zero-recall cases to 43, and global hit/missing/noise ids from 771/323/1488 to 773/321/1487. Target `2:contradiction_resolution:2` now returns chats 88/132 and removes noisy chat 124.
