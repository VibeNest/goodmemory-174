...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-probability-concepts-event-order-current-20260612T114500Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-reading-plan-balance-regen-20260612T113000Z` (the accepted reading-plan baseline regenerated at commit `2a281cf` after the iCloud incident destroyed the original report files; summary metrics reproduce the accepted run exactly), it raises evidence-chat recall to 0.7693941426335792, lowers missed-recall cases to 115/355 and wrong-recall/noise to 258/400 (zero-recall stays 38), and moves global hit/missing/noise ids from 833/261/1382 to 843/251/1359. Target `5:event_ordering:1` goes from recall 0.1667 (2/12) to full recall, returning the twelve probability-concept turns 6/10/14/16/18/20/24/30/34/50/56/58 as six chronological concept pairs while removing all 24 noisy chats. Accepted tradeoff: `5:event_ordering:2` gains one noise id (16, an evidence turn of the recovered target) through same-conversation reinforcement with recall unchanged at 0.5.
