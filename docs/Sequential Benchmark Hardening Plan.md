...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-daily-walking-goal-festival-months-current-20260613T023328Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-sneaker-budget-comparison-current-20260613T021730Z`, it raises evidence-chat recall to 0.8510842834786496, lowers missed-recall cases to 86/355, wrong-recall/noise to 229/400, and zero-recall to 9, and moves global hit/missing/noise ids from 900/194/1233 to 902/192/1228. Target `15:temporal_reasoning:2` goes from zero recall to full recall, returning the two designated turns 36/270 while removing the noisy chats 58/160/214/32/8, with zero new noise and exactly one case delta. The repair adds a `temporalInterval.dailyWalkingGoalFestivalMonths` narrow gate to `sourceOrderTemporalInterval.ts` keyed on the "how many months" / "daily walking goal" / "festival" question, with a start pattern pinned to the April 15 daily-walking-goal turn (36) and an end pattern pinned to the August 22 festival sneaker-outfit turn (270); the assistant echo of the start phrase is excluded by the selector's existing user-tag filter.
