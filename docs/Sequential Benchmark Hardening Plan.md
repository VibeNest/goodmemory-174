...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-reunion-promotion-days-current-20260612T153000Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-resume-tailoring-apply-days-current-20260612T151500Z`, it raises evidence-chat recall to 0.8060138609434385, lowers missed-recall cases to 102/355, wrong-recall/noise to 245/400, and zero-recall to 25, and moves global hit/missing/noise ids from 876/218/1301 to 878/216/1295. Target `6:temporal_reasoning:2` goes from zero recall to full recall, returning the interval pair 120/186 (the family reunion postponed on July 10 for the $15,000 budget proposal, and the promotion celebration with Linda at The Blue Lagoon on September 12) while removing all six noisy chats 188/200/14/66/128/142. Exactly one case delta; no tradeoffs.
