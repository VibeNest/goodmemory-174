...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-movie-watchlist-contradiction-current-20260615T034006Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-patent-webinar-contradiction-current-20260615T032116Z`, it raises evidence-chat recall to 0.9088218198077354, lowers missed-recall cases to 57/355 and wrong-recall/noise to 202/400 (zero-recall stays 0), and moves global hit/missing/noise ids from 973/121/919 to 974/120/916. Target `14:contradiction_resolution:1` ("Have I ever made a watchlist for family movie marathons before?", evidence turns 50/72) goes from recall 0.5 to full recall: it recovers the missing affirmative turn 72 ("add Klaus to our watchlist for the movie marathon") to pair with the already-hit denial turn 50 ("new to making watchlists for family movie marathons ... never done this before"), and sheds its three noisy chats. The repair adds a `movieWatchlist` first-statement/denial contradiction selector to `contradiction.ts`, chained in `selectContradictionEvidencePair`, the second use of the contradiction-pair recipe after the event-order workstream closed. One accepted recall-neutral same-conversation reinforcement ripple (`14:event_ordering:1`, a net-zero noise reshuffle, recall unchanged at 0.17). This is the second contradiction_resolution recovery; eleven such partial-recall cases remain (mostly two-turn pairs at recall 0.5). NOTE: `contradiction.ts` is now 887 lines, so the next contradiction selector requires extracting the per-case pair selectors into a registry/table before adding more (the 900-line bounded-selector cap), mirroring the source-ordered event-order coverage table refactor.
