...
- Latest accepted retained diagnostic: `run-phase63-beam-100k-recall-diagnostic-rules-festival-relationship-duration-current-20260612T183300Z`. Compared with `run-phase63-beam-100k-recall-diagnostic-rules-timeline-date-format-current-20260612T181900Z`, it raises evidence-chat recall to 0.8341828750279454, lowers missed-recall cases to 92/355, wrong-recall/noise to 235/400, and zero-recall to 15, and moves global hit/missing/noise ids from 893/201/1253 to 894/200/1252. Target `12:information_extraction:1` goes from zero recall to full recall, returning the single designated turn 1 while removing the confusable turn 28, with zero new noise and exactly one case delta. Caveat recorded in the evidence predicate: the benchmark designates the assistant career/free-will opener as evidence for the festival relationship-duration question while the actual Stephen/festival/five-years details live in turn 28 (the turn the baseline had retrieved), so live answer slices should expect the duration answer to come from that confusable turn instead of the designated evidence.
