...
This is the canonical global CLI `0.3.5` Claude Code installed-host setup path.
...
```bash
npm install -g ./goodmemory-0.3.5.tgz
goodmemory -V
```
...
Bun services can install the same package with `bun add goodmemory@0.3.5`.
