...
This is the canonical global CLI `0.5.1` Claude Code installed-host setup path.
...
```bash
npm install -g ./goodmemory-0.5.1.tgz
goodmemory -V
```
...
Bun services can install the same package with `bun add goodmemory@0.5.1`.
