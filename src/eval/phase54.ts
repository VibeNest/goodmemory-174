...
const PHASE54_SMOKE_CASE_COUNT = 12;
...
export function createPhase54SmokeAnswer(
  caseDefinition: ImplicitMemBenchResearchCase,
...
export function createPhase54SmokeDependencies(): ImplicitMemBenchResearchDependencies {
  return {
    generateTextAnswer: async (input) => {
      const generated = createPhase54SmokeAnswer(input.caseDefinition, input.profile);
      if (typeof generated !== "string") {
        throw new Error(
          `Phase 54 smoke answer for ${input.caseDefinition.taskFile} requires priming branch access.`,
        );
      }
      return generated;
    },
...
export function judgePhase54TextCase(input: {
  answer: string;
  caseDefinition: ImplicitMemBenchResearchCase;
}): ImplicitMemBenchTextJudgeResult {
...
export function judgePhase54PrimingPair(input: {
  caseDefinition: ImplicitMemBenchResearchCase;
