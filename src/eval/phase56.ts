...
const PHASE56_SMOKE_CASE_COUNT = 12;
...
export function createPhase56SmokeAnswer(
  caseDefinition: ImplicitMemBenchResearchCase,
...
export function createPhase56SmokeDependencies(): ImplicitMemBenchResearchDependencies {
  return {
    generateTextAnswer: async (input) => {
      const generated = createPhase56SmokeAnswer(input.caseDefinition, input.profile);
      if (typeof generated !== "string") {
        throw new Error(
          `Phase 56 smoke answer for ${input.caseDefinition.taskFile} requires priming branch access.`,
        );
      }
      return generated;
    },
...
export function judgePhase56TextCase(input: {
  answer: string;
  caseDefinition: ImplicitMemBenchResearchCase;
}): ImplicitMemBenchTextJudgeResult {
...
export function judgePhase56PrimingPair(input: {
  caseDefinition: ImplicitMemBenchResearchCase;
