...
export function buildJudgePrompt(input: JudgePromptInput): string {
  return [
    ...
    "Use 0-10 scores for identity_understanding, history_continuation, factual_alignment, and relevance.",
    "Rubric: identity_understanding, history_continuation, factual_alignment, relevance, optional personalization.",
