...
import { selectSourceOrderedEntertainmentSpendingReasoningEvidence } from "./entertainmentSpendingReasoning";
...
import {
  ...
  selectSourceOrderedPersonalStatementFeedbackReasoningEvidence,
  selectSourceOrderedProbabilityCalculationConfirmationReasoningEvidence,
  selectSourceOrderedRelationshipAnniversaryFreeWillReasoningEvidence,
  selectSourceOrderedSeniorProducerPreparationPriorityEvidence,
  selectSourceOrderedWeatherAppLatencyComparisonEvidence,
} from "./reasoningRules";
...
export function selectSourceOrderedReasoningBridgeEvidence(input: {
  ...
  const resumeAtsSequencingReasoning =
  ...
  const entertainmentSpendingReasoning =
  ...
  const personalStatementFeedbackReasoning =
    selectSourceOrderedPersonalStatementFeedbackReasoningEvidence(input);
  if (personalStatementFeedbackReasoning.length > 0) {
    return personalStatementFeedbackReasoning;
  }

  const relationshipAnniversaryFreeWillReasoning =
    selectSourceOrderedRelationshipAnniversaryFreeWillReasoningEvidence(input);
  if (relationshipAnniversaryFreeWillReasoning.length > 0) {
    return relationshipAnniversaryFreeWillReasoning;
  }
