...
const FACET_PATTERNS = {
  anniversaryConflict: [
    /\bwork\s+call\b[\s\S]{0,120}\banniversary\b[\s\S]{0,120}\bStephen\b/iu,
    /\bStephen\b[\s\S]{0,120}\banniversary\b[\s\S]{0,120}\bwork\s+call\b/iu,
  ],
  freeWillMotivation: [
  ...
  workMeeting: [
    /\bdeclin(?:e|ed|ing)\b[\s\S]{0,120}\b(?:3\s*PM\s+)?meeting\b[\s\S]{0,120}\bStephen\b/iu,
    /\bStephen\b[\s\S]{0,120}\bmeeting\b[\s\S]{0,120}\bstartup\s+offer\b/iu,
  ],
