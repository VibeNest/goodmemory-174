...
const FACETS = [
  {
    ...
    role: "assistant",
    patterns: [
      /^(?=[\s\S]*\bhuman\s+touch\b)(?=[\s\S]*\bMichael\b)(?=[\s\S]*\bresume\s+screening\b)(?=[\s\S]*\bfinal\s+hiring\s+decisions?\b)(?=[\s\S]*\binterviews?\b)/iu,
      /^(?=[\s\S]*\bhuman\s+touch\b)(?=[\s\S]*\bMichael\b)(?=[\s\S]*\bresume\s+screening\b)(?=[\s\S]*\bfinal\s+decisions?\b)(?=[\s\S]*\binterviews?\b)/iu,
    ],
  },
  {
  ...
  {
    facet: "michaelRoleTiming",
    role: "user",
    patterns: [
      /^(?=[\s\S]*\bMichael\b)(?=[\s\S]*\bediting\s+to\s+HR\s+tech\s+support\b)(?=[\s\S]*\bnew\s+role\b)(?=[\s\S]*\bAI\s+pilot'?s\s+success\b)(?=[\s\S]*\bright\s+time\b)/iu,
    ],
  },
  {
    ...
    role: "user",
    patterns: [
      /^(?=[\s\S]*\bAI\s+to\s+automate\s+hiring\b)(?=[\s\S]*\bfair\b)(?=[\s\S]*\bMichael\b)(?=[\s\S]*\bAI\s+fairness\s+metrics\b)(?=[\s\S]*\bJuly\s+12\b)(?=[\s\S]*\bThe\s+Green\s+Turtle\b)/iu,
    ],
  },
  {
