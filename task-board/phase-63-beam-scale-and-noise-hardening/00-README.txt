...
- Latest accepted retained run: `run-phase63-beam-100k-recall-diagnostic-rules-patent-process-stages-event-order-current-20260614T230256Z`, evidence-chat recall 0.8880795886429688, missed 71/355, wrong-recall/noise 214/400, zero-recall 0.

Current Task Queue
------------------

1. Keep the latest patent-process-stages event-order coverage repair (zero-recall is 0; reducing event_ordering noise one case at a time).
