...
- Latest accepted retained run: `run-phase63-beam-100k-recall-diagnostic-rules-non-provisional-filing-instruction-current-20260613T043954Z`, evidence-chat recall 0.8764363961547059, missed 77/355, wrong-recall/noise 220/400, zero-recall 0.

Current Task Queue
------------------

1. Keep the latest non-provisional-filing instruction repair (zero-recall is now 0 across all 355 evidence cases).
