...
- Latest accepted retained run: `run-phase63-beam-100k-recall-diagnostic-rules-transaction-deployment-weeks-current-20260612T141500Z`, evidence-chat recall 0.7919293539011849, missed 107/355, wrong-recall/noise 250/400, zero-recall 30.

Current Task Queue
------------------

1. Keep the latest transaction-deployment interval repair.
