...
Purpose
-------
Provide an executable closure slice after the accepted phase-16 through phase-19 work.
...
Execution Order
---------------
1. 01-integrated-gate-script.txt
2. 02-release-doc-refresh.txt
3. 03-canonical-acceptance-evidence.txt
